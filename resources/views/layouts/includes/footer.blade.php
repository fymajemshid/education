<!-- footer block -->
    ...
    <script src="{{asset('app-assets/assets/js/jquery-3.3.1.min.js')}}"></script>
    <!-- //common jquery plugin -->

    <!-- /counter-->
    <script src="{{asset('app-assets/assets/js/counter.js')}}"></script>
    <!-- //counter-->

    <!-- theme switch js (light and dark)-->
    <script src="{{asset('app-assets/assets/js/theme-change.js')}}"></script>
    <!-- //theme switch js (light and dark)-->
    ...
    <!-- bootstrap -->
    <script src="{{asset('app-assets/assets/js/bootstrap.min.js')}}"></script>
    <!-- //bootstrap -->
    <!-- //Js scripts -->
</body>
