                ...
                <div class="row align-items-center pt-sm-5 pt-4">
                    ...
                    <div class="col-md-6 right-banner-2 text-end position-relative mt-md-0 mt-5">
                        <div class="sub-banner-image mx-auto">
                            <img src="{{asset('app-assets/assets/images/banner.png')}}" class="img-fluid position-relative" alt=" ">
                        </div>
            ...
            <div class="row pb-xl-5 align-items-center">
                <div class="col-lg-6 position-relative home-block-3-left pb-lg-0 pb-5">
                    <div class="position-relative">
                        <img src="{{asset('app-assets/assets/images/img1.jpg')}}" alt="" class="img-fluid radius-image">
                    </div>
        ...
        <div class="container py-md-5 py-4">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="{{asset('app-assets/assets/images/c1.jpg')}}" alt="" class="img-fluid" />
                            <div class="meta-list">
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="{{asset('app-assets/assets/images/c2.jpg')}}" alt="" class="img-fluid" />
                            <div class="meta-list">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="{{asset('app-assets/assets/images/c3.jpg')}}" alt="" class="img-fluid" />
                            <div class="meta-list">
        ...
        <div class="container pb-md-5 pb-4">
            ...
            <div class="row text-center pt-4">
                <div class="col-md-3 col-6">
                    <div class="counter">
                        <img src="{{asset('app-assets/assets/images/icon-1.png')}}" alt="" class="img-fluid">
        ...
        <div class="container py-md-5 py-4">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card-single">
                        <div class="grids5-info">
                            <a href="#blog"><img src="{{asset('app-assets/assets/images/blog2.jpg')}}" alt="" /></a>
                            <div class="blog-info">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                        <img class="img-fluid" src="{{asset('app-assets/assets/images/testi2.jpg')}}" alt="admin"
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="blog-card-single">
                        <div class="grids5-info">
                            <a href="#blog"><img src="{{asset('app-assets/assets/images/blog1.jpg')}}" alt="" /></a>
                            <div class="blog-info">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                        <img class="img-fluid" src="{{asset('app-assets/assets/images/testi1.jpg')}}" alt="admin"
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="blog-card-single">
                        <div class="grids5-info">
                            <a href="#blog"><img src="{{asset('app-assets/assets/images/blog3.jpg')}}" alt="" /></a>
                            <div class="blog-info">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    <a class="d-flex align-items-center" href="#blog" title="23k followers">
                                        <img class="img-fluid" src="{{asset('app-assets/assets/images/testi3.jpg')}}" alt="admin"
