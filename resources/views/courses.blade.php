        ...
        <div class="container py-md-5 py-4">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="{{asset('app-assets/assets/images/c4.jpg')}}" alt="" class="img-fluid" />
                            <div class="meta-list">
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="{{asset('app-assets/assets/images/c5.jpg')}}" alt="" class="img-fluid" />
                            <div class="meta-list">
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="{{asset('app-assets/assets/images/c6.jpg')}}" alt="" class="img-fluid" />
                            <div class="meta-list">
